...
def cache_name(reference, comparison, full_path=False):
    ...
    :param reference: (list of strings) tastes of one of the whiskies
    :param comparison: (list of strings) tastes of the other whisky
    :param full_path: (boolean) return the file name only if True, or the full
    path with file name if false
...
def pol_coordinates(width, height, sides, scales, margin):
    ...
    :param scales: (int) number of steps (internal reference lines of the grid)
    :param margin: (int) margin between tha edge of the SVG and the chart grid
...
def text_position(x, y, count, position, line_height):
    """
    Returns the position of text labels adjusted for a better visual harmony.
    ...
    :param position: (dictionary of lists) map of position sequential counts to
    position class (string; e.g. right, bottom...)
    :param line_height: (int) height of the text line
...
def text_content(count):
    """
    Return the label of the tasted according to the position sequential count.
    :param count: (int) sequential position count
...
def txt_coordinates(polygon_coordinates, line_height):
    ...
    :param polygon_coordinates: (list of lists of tuples of integers) list
    containing lists of tuples with the x, y coordinates of the grid of the
    chart
    :param line_height: (int) height of the text line
    :return: (list of dictionaries) list containing a dictionary for each label;
    the keys are 'coordinates' (tuple of integers - x, y position of the label),
    'align' (string - value for the text align attribute) and 'content'
    (string - content of the text of the label)
    """
